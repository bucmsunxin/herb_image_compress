...
def cache_url(url, model_dir=None, progress=True):
    ...
    if model_dir is None:
        if osp.exists('/workdir/wangchong/imagenet_dataset/'):
            root_path = '/workdir/wangchong/imagenet_dataset/'
        else:
            root_path = '/opt/data/imagenet_dataset/'
        torch_home = os.path.expanduser(os.getenv('TORCH_HOME', root_path))
